...
function About() {
  return (
    <Container>
      <Row xs={12} md={12} className="justify-content-center">
        <Figure>
          <Figure.Image
            width={171}
            height={180}
      ...
      <Row xs={12} md={12} className="justify-content-center ml-auto">
        <Container className="mt-3">
          <p>
            ...
            at Rutgers University. Currently, I am a Program Analyst for the Configuration Management
            Team at the FAA Tech Center in Atlantic City, NJ. Before I
